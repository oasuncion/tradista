...
public class PricerMeasureUNREALIZED_PNL extends PricerMeasure {
	...
	@Pricing
	public BigDecimal markToModel(PricingParameter params, FXTrade trade, Currency currency,
	...
	public BigDecimal markToMarket(PricingParameter params, FXTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {
