...
public class PricerMeasurePV extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2018023023822637222L;
	...
	public BigDecimal blackAndScholes(PricingParameter params, FXOptionTrade trade, Currency currency,
		...
		return fxOptionPricerBusinessDelegate.pvBlacBkAndScholes(params, trade, currency, pricingDate);
	}
	...
	public BigDecimal coxRossRubinstein(PricingParameter params, FXOptionTrade trade, Currency currency,
		...
		return fxOptionPricerBusinessDelegate.pvCoxRossRubinstein(params, trade, currency, pricingDate);
	}
