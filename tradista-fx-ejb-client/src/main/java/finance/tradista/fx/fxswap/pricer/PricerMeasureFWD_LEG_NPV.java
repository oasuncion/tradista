...
public class PricerMeasureFWD_LEG_NPV extends PricerMeasure {

	private static final long serialVersionUID = 6957246352035416215L;

	private FXSwapPricerBusinessDelegate fxSwapPricerBusinessDelegate;

	public PricerMeasureFWD_LEG_NPV() {
		super();
	...
	public BigDecimal discountedLegsDiff(PricingParameter params, FXSwapTrade trade, Currency currency,
		...
		return fxSwapPricerBusinessDelegate.fwdLegNpvDiscountedLegsDiff(params, trade, currency, pricingDate);
	}
