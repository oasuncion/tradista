...
public class PricerMeasureREALIZED_PNL extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -167025973450472438L;
	...
	public BigDecimal markToMarket(PricingParameter params, FXSwapTrade trade, Currency currency, LocalDate pricingDate)
		...
		return fxSwapPricerBusinessDelegate.realizedPnlMarkToMarket(params, trade, currency, pricingDate);
	}
