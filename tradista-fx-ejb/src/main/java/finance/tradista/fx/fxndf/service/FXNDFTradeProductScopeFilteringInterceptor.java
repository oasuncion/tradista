...
public class FXNDFTradeProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public FXNDFTradeProductScopeFilteringInterceptor() {
		super(FXNDFTrade.FX_NDF);
	}
}
