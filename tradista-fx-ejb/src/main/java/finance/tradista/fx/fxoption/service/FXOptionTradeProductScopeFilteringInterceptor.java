...
public class FXOptionTradeProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public FXOptionTradeProductScopeFilteringInterceptor() {
		super(FXOptionTrade.FX_OPTION);
	}
}
