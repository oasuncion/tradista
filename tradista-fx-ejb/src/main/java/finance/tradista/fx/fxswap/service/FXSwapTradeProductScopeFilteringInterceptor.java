...
public class FXSwapTradeProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public FXSwapTradeProductScopeFilteringInterceptor() {
		super(FXSwapTrade.FX_SWAP);
	}
}
