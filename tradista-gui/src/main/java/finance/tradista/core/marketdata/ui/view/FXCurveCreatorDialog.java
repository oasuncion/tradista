...
public class FXCurveCreatorDialog extends TradistaDialog<FXCurve> {

	public FXCurveCreatorDialog() {
		super();
		setTitle("FX Curve Creation");
		setHeaderText("Please specify a name for the FX Curve to create.");
		...
		setResultConverter(new Callback<ButtonType, FXCurve>() {
			@Override
			public FXCurve call(ButtonType b) {
				if (b == buttonTypeOk) {
