...
public class PricerMeasureNPV extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5531480017530021198L;
	...
	@Pricing
	public BigDecimal discountedLegsDiff(PricingParameter params, CcySwapTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {
		return ccySwapPricerBusinessDelegate.npvDiscountedLegsDiff(params, trade, currency, pricingDate);
	}
