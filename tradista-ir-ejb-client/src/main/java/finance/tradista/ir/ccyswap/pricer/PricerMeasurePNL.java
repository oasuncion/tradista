...
public class PricerMeasurePNL extends PricerMeasure {
	...
	private static final long serialVersionUID = 7827794944583216404L;
	...
	public BigDecimal defaultPNL(PricingParameter params, CcySwapTrade trade, Currency currency, LocalDate pricingDate)
			throws PricerException, TradistaBusinessException {

		return ccySwapPricerBusinessDelegate.pnlDefault(params, trade, currency, pricingDate);
	}
