...
@Parameterizable(name = "Default IRCapFloorCollar Pricer")
public class PricerIRCapFloorCollar extends Pricer {

	private static final long serialVersionUID = 1500306000139551385L;

	public PricerIRCapFloorCollar() {
		super();
