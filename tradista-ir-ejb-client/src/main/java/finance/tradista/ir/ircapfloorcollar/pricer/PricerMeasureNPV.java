...
public class PricerMeasureNPV extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7380032183835586200L;
	...
	public BigDecimal black(PricingParameter params, IRCapFloorCollarTrade trade, Currency currency,
		...
		return irCapFloorCollarPricerBusinessDelegate.npvBlack(params, trade, currency, pricingDate);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PricerMeasureNPV)) {
			return false;
		}
