...
public class PricerMeasurePNL extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8753831569697140231L;
	...
	public BigDecimal defaultPNL(PricingParameter params, IRCapFloorCollarTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {

		return irCapFloorCollarPricerBusinessDelegate.pnlDefault(params, trade, currency, pricingDate);
	}
