...
public class PricerMeasureFORWARD_SWAP_RATE extends PricerMeasure {
	...
	private static final long serialVersionUID = 6863917682195666623L;
	...
	@Pricing
	public BigDecimal forwardSwapRate(PricingParameter params, SingleCurrencyIRSwapTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {
		return irSwapPricerBusinessDelegate.forwardSwapRateForwardSwapRate(params, trade, currency, pricingDate);
	}
