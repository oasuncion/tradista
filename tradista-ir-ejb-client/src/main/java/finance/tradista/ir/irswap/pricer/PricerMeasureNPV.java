...
public class PricerMeasureNPV extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7606663311423475694L;
	...
	@Pricing
	public BigDecimal discountedLegsDiff(PricingParameter params, SingleCurrencyIRSwapTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {
		return irSwapPricerBusinessDelegate.npvDiscountedLegsDiff(params, trade, currency, pricingDate);
	}
