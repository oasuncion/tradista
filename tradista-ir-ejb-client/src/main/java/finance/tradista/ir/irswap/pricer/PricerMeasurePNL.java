...
public class PricerMeasurePNL extends PricerMeasure {
	...
	private static final long serialVersionUID = 4797543740975477297L;
	...
	public BigDecimal defaultPNL(PricingParameter params, SingleCurrencyIRSwapTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {

		return irSwapPricerBusinessDelegate.pnlDefault(params, trade, currency, pricingDate);
	}
