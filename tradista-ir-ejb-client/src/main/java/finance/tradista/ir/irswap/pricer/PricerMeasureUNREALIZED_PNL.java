...
public class PricerMeasureUNREALIZED_PNL extends PricerMeasure {
	...
	private static final long serialVersionUID = -5599604639970743225L;
	...
	public BigDecimal legsDiff(PricingParameter params, SingleCurrencyIRSwapTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {

		return irSwapPricerBusinessDelegate.unrealizedPnlLegsDiff(params, trade, currency, pricingDate);
	}
