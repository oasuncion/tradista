...
public class PricerMeasureFORWARD_SWAP_RATE extends PricerMeasure {
	...
	private static final long serialVersionUID = -6246071467585103837L;
	...
	@Pricing
	public BigDecimal forwardSwapRate(PricingParameter params, IRSwapOptionTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {
		return irSwapOptionPricerBusinessDelegate.forwardSwapRateForwardSwapRate(params, trade, currency, pricingDate);
