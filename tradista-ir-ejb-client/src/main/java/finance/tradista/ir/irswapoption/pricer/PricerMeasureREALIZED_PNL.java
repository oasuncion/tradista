...
public class PricerMeasureREALIZED_PNL extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4067682356586340460L;
	...
	public BigDecimal optionExercise(PricingParameter params, IRSwapOptionTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {

		return irSwapOptionPricerBusinessDelegate.realizedPnlOptionExercise(params, trade, currency, pricingDate);
	}
