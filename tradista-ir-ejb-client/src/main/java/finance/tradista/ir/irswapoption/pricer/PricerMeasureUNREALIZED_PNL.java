...
public class PricerMeasureUNREALIZED_PNL extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7113749794955863671L;
	...
	public BigDecimal black(PricingParameter params,
			Trade<? extends Product> trade, Currency currency, LocalDate pricingDate)
			throws PricerException, TradistaBusinessException {
		
		return irSwapOptionPricerBusinessDelegate.unrealizedPnlBlack(params,
				(IRSwapOptionTrade)trade, currency, pricingDate);		
	}
