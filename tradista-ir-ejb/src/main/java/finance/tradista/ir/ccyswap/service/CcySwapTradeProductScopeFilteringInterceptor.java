...
public class CcySwapTradeProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public CcySwapTradeProductScopeFilteringInterceptor() {
		super(CcySwapTrade.CCY_SWAP);
	}
}
