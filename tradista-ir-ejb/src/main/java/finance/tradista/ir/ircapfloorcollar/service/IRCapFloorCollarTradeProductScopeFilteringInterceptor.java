...
public class IRCapFloorCollarTradeProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public IRCapFloorCollarTradeProductScopeFilteringInterceptor() {
		super(IRCapFloorCollarTrade.IR_CAP_FLOOR_COLLAR);
	}
}
