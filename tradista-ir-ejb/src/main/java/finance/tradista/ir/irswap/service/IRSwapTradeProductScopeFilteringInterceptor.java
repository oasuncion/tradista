...
public class IRSwapTradeProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public IRSwapTradeProductScopeFilteringInterceptor() {
		super(IRSwapTrade.IR_SWAP);
	}
}
