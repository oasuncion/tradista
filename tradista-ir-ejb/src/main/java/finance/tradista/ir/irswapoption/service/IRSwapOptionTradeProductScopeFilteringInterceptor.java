...
public class IRSwapOptionTradeProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public IRSwapOptionTradeProductScopeFilteringInterceptor() {
		super(IRSwapOptionTrade.IR_SWAP_OPTION);
	}
}
