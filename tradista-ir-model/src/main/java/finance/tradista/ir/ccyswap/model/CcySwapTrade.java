...
under the License.    */
/**
 * Class to represent Cross-Currency swaps.
 * Note :
 * notionalAmountTwo : the notional received at the starting of the trade, and paid at the maturity of the trade
 * currencyTwo : the currency of the fixed leg (to pay)
 * @author OA
 *
 * @param <P>
 */
