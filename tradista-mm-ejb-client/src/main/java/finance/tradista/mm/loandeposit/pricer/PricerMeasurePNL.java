...
public class PricerMeasurePNL extends PricerMeasure {
	...
	public BigDecimal defaultPNL(PricingParameter params, LoanTrade trade, Currency currency,
	...
	@Pricing(defaultPNL = true)
	public BigDecimal defaultPNL(PricingParameter params, DepositTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {
