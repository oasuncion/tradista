...
public class PricerMeasureREALIZED_PNL extends PricerMeasure {
	...
	public BigDecimal realizedPnl(PricingParameter params, LoanTrade trade, Currency currency,
	...
	@Pricing(defaultREALIZED_PNL = true)
	public BigDecimal realizedPnl(PricingParameter params, DepositTrade trade, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {
