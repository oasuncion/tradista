...
public class PricerMeasureUNREALIZED_PNL extends PricerMeasure {
	...
	private static final long serialVersionUID = 5278348916779346690L;
	...
	public BigDecimal unrealizedPnl(PricingParameter params, LoanTrade trade, Currency currency, LocalDate pricingDate)
			throws PricerException, TradistaBusinessException {

		return loanDepositPricerBusinessDelegate.unrealizedPnlDefault(params, trade, currency, pricingDate);
	}

	@Pricing(defaultUNREALIZED_PNL = true)
	public BigDecimal unrealizedPnl(PricingParameter params, DepositTrade trade, Currency currency,
