...
public class LoanDepositTradeProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public LoanDepositTradeProductScopeFilteringInterceptor() {
		super(LoanDepositTrade.LOAN_DEPOSIT);
	}
}
