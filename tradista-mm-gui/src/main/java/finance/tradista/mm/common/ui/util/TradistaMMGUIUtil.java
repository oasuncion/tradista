...
public final class TradistaMMGUIUtil {
	...
	public static void fillLoanDepositTypeComboBox(ComboBox<LoanDepositTrade.Direction>... comboBoxes) {
		ObservableList<LoanDepositTrade.Direction> data = FXCollections.observableArrayList(LoanDepositTrade.Direction.values());
	...
	public static void fillLoanDepositInterestTypeComboBox(ComboBox<LoanDepositTrade.InterestType>... comboBoxes) {
		ObservableList<LoanDepositTrade.InterestType> data = FXCollections.observableArrayList(LoanDepositTrade.InterestType.values());
		if (comboBoxes.length > 0) {
