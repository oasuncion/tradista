...
public enum TransferPurpose {
	...
	INTEREST_PAYMENT, PRIMARY_CURRENCY, QUOTE_CURRENCY, CASH_SETTLEMENT, PREMIUM, PRIMARY_CURRENCY_SPOT, QUOTE_CURRENCY_SPOT, PRIMARY_CURRENCY_FORWARD, QUOTE_CURRENCY_FORWARD, FIXED_LEG_INTEREST_PAYMENT, FIXED_LEG_NOTIONAL_PAYMENT, FIXED_LEG_NOTIONAL_REPAYMENT, FLOATING_LEG_INTEREST_PAYMENT, FLOATING_LEG_NOTIONAL_PAYMENT, FLOATING_LEG_NOTIONAL_REPAYMENT, BOND_SETTLEMENT, COUPON, BOND_PAYMENT, NOTIONAL_PAYMENT, NOTIONAL_REPAYMENT, DIVIDEND, EQUITY_SETTLEMENT, EQUITY_PAYMENT, EQUITY_OPTION_SETTLEMENT, FUTURE_SETTLEMENT;
