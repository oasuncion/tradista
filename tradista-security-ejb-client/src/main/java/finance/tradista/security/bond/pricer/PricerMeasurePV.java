...
public class PricerMeasurePV extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8087875386122651362L;
	...
	public BigDecimal discountedCashFlow(PricingParameter params, BondTrade trade, Currency currency,
		...
		return bondPricerBusinessDelegate.pvDiscountedCashFlow(params, trade, currency, pricingDate);
	}
