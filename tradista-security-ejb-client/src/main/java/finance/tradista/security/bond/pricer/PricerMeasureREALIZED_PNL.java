...
public class PricerMeasureREALIZED_PNL extends PricerMeasure {
	...
	private static final long serialVersionUID = 2703454148406424024L;
	...
	public BigDecimal realizedPnl(PricingParameter params, Bond product, Book book, Currency currency,
			LocalDate pricingDate) throws PricerException, TradistaBusinessException {

		return bondPricerBusinessDelegate.realizedPnlDefault(params, product, book, currency, pricingDate);
	}
