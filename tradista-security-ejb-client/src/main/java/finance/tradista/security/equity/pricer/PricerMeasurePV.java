...
public class PricerMeasurePV extends PricerMeasure {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3553593578126316134L;
	...
	public BigDecimal monteCarloSimulation(PricingParameter params, EquityTrade trade, Currency currency,
		...
		return equityPricerBusinessDelegate.pvMonteCarloSimulation(params, trade, currency, pricingDate);
	}
