...
public class PricerMeasureEXPOSURE extends PricerMeasure {
	...
	private static final long serialVersionUID = -9172876293283298193L;
	...
	@Pricing
	public BigDecimal exposure(PricingParameter params, GCRepoTrade trade, Currency currency, LocalDate pricingDate)
			throws TradistaBusinessException {
		return gcRepoPricerBusinessDelegate.getExposure(trade, currency, pricingDate, params);
	}
}