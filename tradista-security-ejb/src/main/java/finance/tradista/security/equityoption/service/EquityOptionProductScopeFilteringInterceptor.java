...
public class EquityOptionProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public EquityOptionProductScopeFilteringInterceptor() {
		super(EquityOption.EQUITY_OPTION);
	}
}
