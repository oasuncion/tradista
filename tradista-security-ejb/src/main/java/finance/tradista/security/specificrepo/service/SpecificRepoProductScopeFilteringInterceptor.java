...
public class SpecificRepoProductScopeFilteringInterceptor extends ProductScopeFilteringInterceptor {

	public SpecificRepoProductScopeFilteringInterceptor() {
		super(SpecificRepoTrade.SPECIFIC_REPO);
	}
}
